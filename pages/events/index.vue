<template>
  <div class="mains">
    ...
    <div id="test" class="events">

      <div v-for="entry in events" v-bind:key="entry">
        <Event v-if="entry.sidebar" :project="entry" :sidebar="'true'" />

        <Event v-else :project="entry" :sidebar="'false'" />
      </div>
