...
.caption
  ...
  a
    ...
    background: linear-gradient(to bottom, rgba(147, 206, 222, 1) 0%, rgba(66, 170, 199, 1) 41%, rgba(1, 104, 149, 1) 100%)
    position: relative
    top: 0px
    margin: 0px
    color: white
    ...
    &:hover
      background: rgba(147, 206, 222, 1)
      background: linear-gradient(to bottom, rgba(147, 206, 222, 1) 0%, rgba(66, 170, 199, 1) 41%, rgba(0, 96, 129, 1) 100%)
  .title
    display: -webkit-box
    display: -ms-flexbox
    display: flex
